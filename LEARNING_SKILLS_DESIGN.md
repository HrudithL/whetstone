...
{ "status": "committed" | "reinforced" | "noop" | "conflict" | "possible_contradiction" | "needs_confirmation", "entry_id": "L13", "recurrence": 1,
  ...
  "existing_body": "…the flagged entry's own current wording (possible_contradiction only, §M7c)…",
  "candidate_body": "…the new, uncommitted candidate wording (possible_contradiction only, §M7c)…",
